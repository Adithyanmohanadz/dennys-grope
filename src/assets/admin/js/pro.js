...
function sidebarColor(e) {
  for (var t = e.parentElement.children, a = e.getAttribute("data-color"), n = 0; n < t.length; n++)
  ...
  e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"),
    ...
    document.querySelector("#sidenavCard") &&
      ...
      (a = document.querySelector("#sidenavCard+.btn")).removeAttribute("class"),
      a.classList.add(...e));
}
      ...
      (sidenavToggler.onclick = function () {
        sidenavShow.classList.contains("g-sidenav-hidden")
          ? (sidenavShow.classList.remove("g-sidenav-hidden"),
            ...
            toggleNavbarMinimize &&
              (toggleNavbarMinimize.click(), toggleNavbarMinimize.removeAttribute("checked")))
          : (sidenavShow.classList.remove("g-sidenav-pinned"),
            sidenavShow.classList.add("g-sidenav-hidden"),
            toggleNavbarMinimize &&
              (toggleNavbarMinimize.click(), toggleNavbarMinimize.setAttribute("checked", "true")));
      }));
...
function navbarColorOnResize() {
  sidenav &&
    (1200 < window.innerWidth
      ...
      : (sidenav.classList.add("bg-white"), sidenav.classList.remove("bg-default")));
}
  ...
  if (e.getAttribute("checked")) {
    ...
    for (C = 0; C < v.length; C++)
      v[C].classList.contains("bg-gray-600") &&
        (v[C].classList.remove("bg-gray-600"), v[C].classList.add("bg-gray-100"));
    ...
    t.classList.add("dark-version"),
      x.includes("logo-ct-dark.png") && ((q = x.replace("logo-ct-dark", "logo-ct")), (w.src = q));
    ...
    for (var C = 0; C < m.length; C++)
      m[C].classList.contains("bg-gray-100") &&
        (m[C].classList.remove("bg-gray-100"), m[C].classList.add("bg-gray-600"));
  ...
  showSwal: function (e) {
    if ("basic" == e) Swal.fire("Any fool can use a computer");
      ...
      s.fire({
        ...
        e.isConfirmed &&
          Swal.fire({ title: e.value.login + "'s avatar", imageUrl: e.value.avatar_url });
      });
    }
  },
};
