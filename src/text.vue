                    ...
                    <div class="row align-items-end g-3">
                      ...
                      <div class="col-md-3 col-12 d-flex flex-column align-items-end">
                        ...
                        <div v-else>
                          <div class="price-tag text-end mb-2 mt-lg-n6">
                            <template v-if="getActiveSubItem(item)">
                              ...
                              <div class="d-flex align-items-center gap-1">
                                <!-- GST label: Incl. GST if tax was applied, Excl. GST otherwise -->
                                <span
                                ...
                                <!-- Main selling price (GST included) -->
                              ...
                              <!-- Strikethrough: original price from API (before discount, no GST added) -->
                          ...
                          <button class="btn btn-dark-modern w-100" :disabled="!getActiveSubItem(item)"
...
const addToCart = (item) => {
  ...
  const payload = {
    ...
    unit: subItem.unit,
    price: subItem.gst_included_price,
  };
